document.addEventListener('DOMContentLoaded', () => {
    ...
    function initLocationPicker() {
        ...
        if (! addressInput || ! latitudeInput || ! longitudeInput || ! locationModal) {
            return;
        }
        ...
        const initialCoordinates = hasSavedCoordinates
        ...
        if (hasSavedCoordinates) {
            marker = window.L.marker(initialCoordinates).addTo(map);
